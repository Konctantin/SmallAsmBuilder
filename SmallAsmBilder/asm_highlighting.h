...
static SScintillaColors AsmSyntaxStyle[] = {
    { SCE_ASM_DEFAULT			 , 0x000000 , 0xFFFFFF, TRUE  , 12, "Courier New" },
    { SCE_ASM_STRINGEOL			 , 0x000000 , 0xFFFFFF, TRUE  , 12, "Courier New" },
    { SCE_ASM_IDENTIFIER		 , 0x000000 , 0xFFFFFF, TRUE  , 12, "Courier New" },
    { SCE_ASM_COMMENTDIRECTIVE   , 0x000000 , 0xFFFFFF, TRUE  , 12, "Courier New" },
    { SCE_ASM_COMMENT			 , 0x2B8000 , 0xFFFFFF, FALSE , 12, "Courier New" },
    { SCE_ASM_NUMBER			 , 0xFF00FF , 0xFFFFFF, FALSE , 12, "Courier New" },
    { SCE_ASM_STRING			 , 0x808080 , 0xFFFFFF, FALSE , 12, "Courier New" },
    { SCE_ASM_OPERATOR			 , 0x800000 , 0xFFFFFF, TRUE  , 12, "Courier New" },
    { SCE_ASM_CPUINSTRUCTION	 , 0xFF0000 , 0xFFFFFF, TRUE  , 12, "Courier New" },
    { SCE_ASM_MATHINSTRUCTION	 , 0xC08000 , 0xFFFFFF, TRUE  , 12, "Courier New" },
    { SCE_ASM_REGISTER			 , 0xFF8080 , 0xFFFFFF, TRUE  , 12, "Courier New" },
    { SCE_ASM_DIRECTIVE		     , 0xFF8000 , 0xFFFFFF, FALSE , 12, "Courier New" },
    { SCE_ASM_DIRECTIVEOPERAND   , 0x800000 , 0xFFFFFF, TRUE  , 12, "Courier New" },
    { SCE_ASM_COMMENTBLOCK		 , 0x2B8000 , 0xFFFFFF, FALSE , 12, "Courier New" },
    { SCE_ASM_CHARACTER		     , 0x008080 , 0xFFFFFF, FALSE , 12, "Courier New" },
    { SCE_ASM_EXTINSTRUCTION	 , 0x004080 , 0xFFFFFF, TRUE  , 12, "Courier New" },
    { STYLE_LINENUMBER           , 0x444444 , 0xFFFFFF, FALSE , 12, "Courier New" },
    { STYLE_DEFAULT              , 0x000000 , 0xFFFFFF, TRUE  , 12, "Courier New" },
};

static const char* AsmKeyWords[] =
{
    // CPU instructions
    "aaa aad aam aas daa das "
    "ja jae jb jbe jc jcxz je jg jge jl jle jmp jna "
    "jnae jnb jnbe jnc jne jng jnge jnl jnle jno jnp jns jnz "
    "jo jp jpe jpo js jz "
    "jcxz jecxz jrcxz "
    "loop loope loopne loopz loopnz "
    "call ret "
    "add sub adc sbb neg cmp inc dec "
    "and or xor not test "
    ...
    "cmovo cmovno cmovb cmovc cmovnae cmovae cmovnb "
    ...
    // Registers
    "al ah bl bh cl ch dl dh  ax bx cx dx si di bp "
    "eax ebx ecx edx esi edi ebx esp st0 st1 st2 st3 st4 st5 st6 st7 "
    "mm0 mm1 mm2 mm3 mm4 mm5 mm6 mm7 "
    "xmm0 xmm1 xmm2 xmm3 xmm4 xmm5 xmm6 xmm7"
    "ymm0 ymm1 ymm2 ymm3 ymm4 ymm5 ymm6 ymm7 "
    "fs "
    "r8b r9b r10b r11b r12b r13b r14b r15b r8w r9w r10w r11w r12w r13w r14w r15w "
    "rax rcx rdx rbx rsp rbp rsi rdi r8 r9 r10 r11 r12 r13 r14 r15 "
    "xmm8 xmm9 xmm10 xmm11 xmm12 xmm13 xmm14 xmm15 ymm8 ymm9 ymm10 ymm11 ymm12 ymm13 ymm14 ymm15 "
    "gs",
